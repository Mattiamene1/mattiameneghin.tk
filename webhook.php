...
shell_exec("echo \"         Is_dir: " . var_export(is_dir($LOCAL_REPO), true) . " \" >> " . $LOCAL_ROOT . "/log.txt");
shell_exec("echo \"         File_exists: " . var_export(file_exists($LOCAL_REPO), true) . " \" >> " . $LOCAL_ROOT . "/log.txt");
